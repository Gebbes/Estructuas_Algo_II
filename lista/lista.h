...
// El iterador apuntara al siguiente elemento y devuelve true si es un elemento valido.
//  Si estuviese al final, devuelve false.
// Pre: el iterador fue creado.
bool lista_iter_avanzar(lista_iter_t *iter);

// Devuelve el valor del elemento actual, si estuviese al final, devuelve NULL.
// Pre: el iterador fue creado.
...
// Inserta el nuevo elemento a la lista, detras del elemento actual. Devuelve true en caso de
// exito y false de lo contrario.
// Pre: el iterador fue creado.
// Post: se añadio un nuevo elemento a la lista y el iterador apuntara a este mismo.
// Se modifico la lista. Devuelve true en caso de exito y false de lo contrario.
bool lista_iter_insertar(lista_iter_t *iter, void *dato);

// Elimina el elemento actual de la lista, y el iterador apuntara al siguiente. Devuelve
// el elemento.
// Pre: el iterador fue creado.
// Post: se elimino el elemento de la lista y el iterador apuntara al siguiente.
// Se modifico la lista y se devuelve el elemento
